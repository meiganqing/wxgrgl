            ...
            if (res.rows) {
                ...
                this.setData({
                    xm: {
                        ...
                        xmyq: res.rows[0].xmyq,
                        cbwnr: res.rows[0].cbwnr,
                        catalog: res.rows[0].catalog,
                        numWord: res.rows[0].numWord,
                        numPic: res.rows[0].numPic,
                        numColor: res.rows[0].numColor,
                        numOther: res.rows[0].numOther,
                        xwcbsj: res.rows[0].xwcbsj,
                        publishing_house: res.rows[0].publishing_house,
                    },
